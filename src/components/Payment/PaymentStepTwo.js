    ...
    <div className="partTwo__container">
      <div className="container-fluid">
        ...
        <div className="payment__select">
          <Link to="/compte/solde" className="payment__type select-tab">
            <img src={pig} alt="Solde du compte" className="partTwo__icon" />
            <p className="payment__type-title">Solde du compte</p>
            <p className="payment__solde">Solde actuel : <span className="bold">30,00€</span></p>
          </Link>
          <div className="payment__type select-tab" data-tab="paypal">
            <img src={paypal} alt="Solde du compte" className="payment__icon" />
            <p className="payment__type-title">Paypal</p>
          </div>
          <div className="payment__type select-tab select-tab--current" data-tab="card">
            <img src={creditCard} alt="Solde du compte" className="payment__icon" />
