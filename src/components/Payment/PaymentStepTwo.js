                ...
                <div className="card visa-card">
                  <div className="card__top">
                    <div className="card__icons-container">
                      <img src={edit} alt="Editer la cart" className="card__icons" />
                      <img src={trashBlanc} alt="Supprimer la cart" className="card__icons" />
                    </div>
              ...
              <div className="card-container">
                <div className="card master-card">
                  <div className="card__top">
                    ...
                    <img src={mastercard} alt="Type de carte" className="card__type" />
                  </div>
                  <div className="card__middle">
